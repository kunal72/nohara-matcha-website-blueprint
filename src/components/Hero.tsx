...
const Hero = () => {
  return <div className="relative min-h-screen flex items-center pt-20 overflow-hidden leaf-pattern">
      {/* Background Elements */}
        ...
        <div className="flex flex-col lg:flex-row items-center">
          <div className="lg:w-1/2 mb-12 lg:mb-0 max-w-xl">
            <div className="mb-6 flex justify-start">
              <img src={images.noharaLogo} alt="Nohara Logo" className="h-16 w-auto" />
            </div>
            ...
            <p className="text-lg md:text-xl text-matcha-dark/80 mb-8 animate-fade-in" style={{
            animationDelay: '0.3s'
          }}>
          ...
          animationDelay: '0.9s'
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-10 left-10 w-6 h-6 bg-matcha-cream/30 rounded-full animate-float" style={{
              animationDelay: '1.5s'
            }}></div>
              <div className="absolute top-1/4 left-5 w-4 h-4 bg-matcha-cream/30 rounded-full animate-float" style={{
              animationDelay: '1s'
            }}></div>
            </div>
          </div>
